  ...
  return (
    <div className="page-body">
      ...
      {loading ? (
        ...
        <>
          {watching.length > 0 && <><div className="section-title">▶️ Currently Watching</div><MovieGrid movies={watching} emptyIcon="▶️" emptyTitle="" emptyText="" /><div style={{ marginBottom:28 }} /></>}
          {planned.length > 0  && <><div className="section-title">⏳ Plan to Watch</div><MovieGrid movies={planned}   emptyIcon="⏳" emptyTitle="" emptyText="" /><div style={{ marginBottom:28 }} /></>}
          {finished.length > 0 && <><div className="section-title">✅ Finished</div><MovieGrid movies={finished} emptyIcon="✅" emptyTitle="" emptyText="" /></>}
        </>
      )}
    </div>
  );
